  ...
  return (
    <>
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative border-b-[3px] border-gold bg-muted/30">
          <div className="px-6 py-20 sm:px-10 sm:py-24 lg:px-14 lg:py-32">
            ...
            <h1 className="enter font-serif text-5xl font-light leading-[0.95] tracking-tight text-foreground sm:text-7xl lg:text-[6rem]">
              A family-first
              <br />
              <em className="font-light text-gold">investment.</em>
            </h1>
          ...
          <section className="relative border-b border-border px-6 py-16 sm:px-10 sm:py-20 lg:px-14 lg:py-24">
            <div className="mx-auto max-w-5xl">
              ...
              <h2 className="font-serif text-4xl font-light leading-[1.05] tracking-tight text-foreground sm:text-5xl lg:text-[3.4rem]">
                ...
                <em className="font-light text-gold">asking.</em>
              </h2>
              ...
              <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 lg:gap-6">
                {threeQuestions.map((item) => (
                  <article
                    key={item.qNum}
                    className="flex flex-col gap-4 rounded-lg border border-border bg-muted/30 p-6 sm:p-8"
                  >
                    <span className="text-[10px] font-medium uppercase tracking-[0.18em] text-gold">
                      {item.qNum}
                    </span>
                    <h3 className="font-serif text-2xl font-light leading-tight tracking-tight text-foreground">
                      {item.headline}
                    </h3>
        ...
        <Reveal>
          <section className="relative border-b border-border bg-muted/30 px-6 py-16 sm:px-10 sm:py-20 lg:px-14 lg:py-24">
            <div className="mx-auto max-w-4xl">
              ...
              <h2 className="font-serif text-4xl font-light leading-[1.1] tracking-tight text-foreground sm:text-5xl lg:text-[3rem]">
                The income that funds{" "}
                <em className="font-light text-gold">everything else.</em>
              </h2>
              <div className="mt-7 max-w-2xl space-y-5 text-base leading-relaxed text-muted-foreground sm:text-[1.05rem]">
                <p>
                  Most of what you want, for yourself, for your family, for
                  the people you care about, depends on your ability to
                  earn. Disability insurance and critical illness coverage
                  replace some or all of that income when something
                  interrupts it. They&apos;re not glamorous. They&apos;re
                  foundational.
                </p>
                <p>
                  Long-term care insurance covers the costs of extended
                  assistance later in life, costs that, in Canada, are not
                  fully covered by provincial health systems. For couples
                  planning a 30-year retirement, this is increasingly part
                  of the conversation.
                </p>
              </div>
            </div>
        ...
        <Reveal>
          <section className="relative border-b border-border px-6 py-16 sm:px-10 sm:py-20 lg:px-14 lg:py-24">
            <div className="mx-auto max-w-4xl">
              ...
              <h2 className="font-serif text-4xl font-light leading-[1.1] tracking-tight text-foreground sm:text-5xl lg:text-[3rem]">
                The gap{" "}
                <em className="font-light text-gold">life insurance closes.</em>
              </h2>
              <div className="mt-7 max-w-2xl space-y-5 text-base leading-relaxed text-muted-foreground sm:text-[1.05rem]">
                <p>
                  Life insurance answers a simple question: if you weren&apos;t
                  here tomorrow, what would change for the people you love,
                  and how much of that change can be made less harsh by money
                ...
                <p>
                  ...
                  insurance (whole life or universal life) becomes a
                  long-term planning instrument. Both work. Which one is
                  right depends on what the policy needs to do.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="relative border-b border-border bg-muted/30 px-6 py-16 sm:px-10 sm:py-20 lg:px-14 lg:py-24">
            <div className="mx-auto max-w-4xl">
              ...
              <h2 className="font-serif text-4xl font-light leading-[1.1] tracking-tight text-foreground sm:text-5xl lg:text-[3rem]">
                ...
                <em className="font-light text-gold">pass it on.</em>
              </h2>
              <p className="mt-7 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-[1.05rem]">
                Permanent life insurance can be one of the most efficient
                ways to transfer wealth to the next generation, paying out
                outside your estate, free of probate, and (in most cases)
                tax-free to your beneficiaries. For families with significant
                assets, this isn&apos;t just protection, it&apos;s a
                planning instrument that can meaningfully shift how much of
                what you&apos;ve built actually arrives where you want it.
              </p>
            </div>
          </section>
        </Reveal>
            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:gap-6">
                {coverage.map((col) => (
                  <div
                    key={col.label}
                    className="flex flex-col gap-5 rounded-lg border border-border bg-background p-6 sm:p-8"
                  >
                    ...
                    {col.cta && (
                      <a
                        ...
                        className="focus-ring mt-auto inline-flex items-center gap-2 self-start border-b border-gold pb-1 text-xs font-medium uppercase tracking-[0.1em] text-foreground transition-colors hover:text-gold"
                      >
                        {col.cta.label}
        ...
        <Reveal>
          <section className="relative border-b border-border bg-navy-deep px-6 py-20 sm:px-10 sm:py-24 lg:px-14 lg:py-28">
            <div className="mx-auto max-w-3xl">
              <div className="mb-6 flex items-center gap-2.5 text-[10px] font-medium uppercase tracking-[0.2em] text-gold">
                <span aria-hidden="true" className="inline-block h-px w-5 bg-gold" />
                How We Do This Differently
              </div>
              <h2 className="font-serif text-4xl font-light leading-[1.05] tracking-tight text-cream sm:text-5xl lg:text-[3.4rem]">
                Insurance isn&apos;t something we sell. It is something{" "}
                <em className="font-light text-gold">we show you.</em>
              </h2>
              <div className="mt-7 space-y-5 text-base leading-relaxed text-cream/70 sm:text-[1.05rem]">
                <p>
                  Most insurance conversations start by selling you a product.
                  Ours starts by modeling your plan, and then asking{" "}
                  <em className="font-serif italic text-cream">
                    what changes if something happens?
                  </em>{" "}
                  You see, in the same scenario tool that runs your retirement
                  income, exactly what role insurance plays. How much you
                  need. How much you don&apos;t. Where it fits.
                </p>
            ...
            <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-6">
              <div>
                <h2 className="font-serif text-3xl font-light leading-tight tracking-tight text-foreground sm:text-4xl">
                  ...
                  <em className="font-light text-gold">your plan?</em>
                </h2>
              </div>
